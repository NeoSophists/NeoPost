export default {
  ...
  GetPublications: {
    GET_PUBLICAION_REQUEST: "GET_PUBLICAION_REQUEST",
    GET_PUBLICAION_SUCCESS: "GET_PUBLICAION_SUCCESS",
    GET_PUBLICAION_PENDING: "GET_PUBLICAION_PENDING",
    GET_PUBLICAION_FAILURE: "GET_PUBLICAION_FAILURE",
  },
  PostPublication: {
